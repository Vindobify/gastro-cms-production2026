  ...
  useEffect(() => {
    ...
    if (couponCode) {
      ...
      if (categorySlug && categorySlug !== 'speisekarte') {
        ...
        window.location.href = `/frontend/speisekarte/${categorySlug}?coupon=${couponCode}`;
        return;
      }
          ...
          if (response.ok) {
            ...
            if (couponData.categoryId) {
              ...
              if (categoryResponse.ok) {
                ...
                window.location.href = `/frontend/speisekarte/${categoryData.slug}?coupon=${couponCode}`;
                return;
              }
            }
    ...
    const fetchData = async () => {
      try {
        ...
        if (categoriesRes.ok) {
          ...
          // Set first category as default (no "Alle" option)
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <SEOHead
        ...
        canonical="/frontend/speisekarte"
        ogType="website"
      />
      
      <CanonicalTag path="/frontend/speisekarte" />
            ...
            <div className={`bg-white rounded-xl shadow-lg p-6 ${sidebarOpen ? 'fixed top-4 left-4 right-4 z-50 max-h-[90vh] overflow-y-auto' : 'sticky top-8'} md:static md:max-h-none md:overflow-visible`}>
              ...
              {sidebarOpen && (
                <div className="flex justify-between items-center mb-4 md:hidden">
                  <h3 className="text-lg font-semibold text-gray-900">Filter & Kategorien</h3>
                  <button
                    onClick={() => setSidebarOpen(false)}
