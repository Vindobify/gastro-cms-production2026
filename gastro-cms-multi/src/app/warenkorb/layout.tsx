...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Warenkorb - Gastro CMS',
    template: '%s | Gastro CMS'
  },
  description: 'Ihr Warenkorb mit ausgewählten Gerichten. Bestellen Sie jetzt online!',
  keywords: ['Warenkorb', 'Bestellung', 'Restaurant', 'Online bestellen', 'Lieferservice'],
  openGraph: {
    type: 'website',
    locale: 'de_DE',
    title: 'Warenkorb - Gastro CMS',
    description: 'Ihr Warenkorb mit ausgewählten Gerichten. Bestellen Sie jetzt online!',
    siteName: 'Gastro CMS',
    images: [{
      url: '/favicon.ico',
