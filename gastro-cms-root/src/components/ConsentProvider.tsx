...
// Dynamischer Import für Analytics-Komponenten
const ConsentScripts = dynamic(() => import('@/components/ConsentScripts'), {
  ssr: false,
})

const GA4Pageview = dynamic(() => import('@/components/GA4Pageview'), {
  ssr: false,
})
...
export function ConsentReOpenButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-40 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
